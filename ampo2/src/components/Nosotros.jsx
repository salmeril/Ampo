...
const Nosotros = () => {
  return (
    <section className="h-[75vh] md:h-[55vh] flex grid lg:grid-rows-2 gap-4 mt-5 bg-[url('/src/assets/images/nosFondo.png')]">
        <div className="font-title mt-5 md:mt-10 text-5xl md:text-6xl lg:text-8x  text-stone-500 font-semibold text-center lg:row-span-1">
            <h1 className="mt-20 m-3 ">Los mejores precios en envases plasticos y de vidrio</h1>
        </div>
        <div className="flex justify-center lg:row-span-2 items-center h-full">
