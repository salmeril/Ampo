...
const Nosotros = () => {
  return (
    <section id="inicio" className="h-[100vh] md:h-[100vh] xl:h-[100vh] grid lg:grid-rows-2 gap-4 mt-5 bg-[url('/src/assets/images/nosFondo.png')] lg:mt-[10vh]">
        <div className="font-title mt-1 md:mt-10 text-5xl md:text-6xl lg:text-7xl text-stone-500 font-semibold text-center lg:mt-2 lg:row-span-1">
            <h1 className="mt-28 m-3 xl:mt-32 ">Los mejores precios en envases plasticos y de vidrio</h1>
        </div>
